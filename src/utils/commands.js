...
let commandList = [
	...
	// 	name: ["twitter"],
	// 	action: true,
	// 	response: 'Visit: <a href="https://twitter.com/alberto">alberto</a>',
	// 	subPathStrict: [false],
	...
	},
	{
		name: ["whoami"],
		action: true,
		response: "Alberto Peral <br/> I'm a Front-End / Full Stack Developer",
		subPathStrict: [false],
		description:
...
const fileList = [
	{
		name: ".github",
		link: "https://github.com/PeralStudio/",
		folder: true,
		executable: false,
	},
	{
